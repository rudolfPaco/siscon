...
public class SIUTabla {
    ...
    public SIUTabla(SIUPanel panel, Grid grid, String[] nombreCabecera, Class[] tipos, int[] porcentajes, ArrayList lista, ModeloTabla modelo){
        this.panel = panel;
        this.grid = grid;
    ...
    public void agregarAnchoColumnas(int[] porcentajes) {
        int ancho = grid.getAnchoTotal();//panel.getGrid().getAncho(grid.getNroColumnas());//deslizador.getWidth();
        int anchoColumna;
