...
public class Crypto {
    ...
    public static void main(final String[] args) {
        ...
        final String secretKey = "MD5";
        final Crypto crypto = new Crypto();

        final String encryptedData = crypto.encrypt("sistema contable", iv, secretKey);
        System.out.println(encryptedData);

        final String decryptedData = crypto.decrypt("QGPMalpbkn7nqypjMo3JRA==", iv, secretKey);
