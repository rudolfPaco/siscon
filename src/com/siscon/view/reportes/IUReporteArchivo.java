 ...
 * @author neo
 */
public class IUReporteArchivo extends IUSecundario{
    ...
    public IUReporteArchivo(REmisionPC ventanaPrincipal, String titulo, String tipoSize, Usuario usuario, Tabvar tabvar, String nombreNivel, String nombreGrupo, String grupos, String nivel) {
    ...
    private void construirPanelDatos(Area a){
        ...
        CConmae.getLista("SELECT * FROM CONMAE WHERE GRUP = "+grupos+" AND NIVEL <= "+nivel), 
