 ...
 * @author neo
 */
public class VNuevoPlanCuentas  extends IUSecundario{
    ...
    public VNuevoPlanCuentas(VPrincipal ventanaPrincipal, String titulo, String tipoSize, Usuario usuario, Tabvar tabvar) {
